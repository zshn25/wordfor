//! Android JNI bridge for WordFor.
//!
//! The platform (Kotlin) handles ONNX inference and calls `search_with_vector()`
//! to pass the float32 query vector to Rust for scoring + ranking.
